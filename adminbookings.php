...
if(isset($_POST["update"]))
    ...
    <div class="card-body">
      ...
      <p class="card-text">Category <input class="form-control " type="text" name="categoryid" value="<?php echo $r['categoryid'];?>"></p>
      <p class="card-text">Date<input  class="form-control " type="text" name="date" value="<?php echo $r['date'];?>"></p>
      <p class="card-text">Status<input class="form-control " type="text" name="status" value="<?php echo $r['status'];?>"></p>
